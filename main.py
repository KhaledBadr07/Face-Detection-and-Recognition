...
class MainApp(QMainWindow, FORM_CLASS):
    ...
    def show_image(self, image, mode):
        ...
        pixmap = pixmap.scaled(900, 500, Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    def detect_faces(self):
        ...
        scaled_pixmap = resulted_pixmap.scaled(900, 500, Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    def get_id(self, distances):
        ...
        for index, distance in enumerate(distances):
            if (distance <= threshold):
                ...
                names = {1: "Emad", 2: "Nabil", 3: "Khaled", 4: "Ahmed", 5: "Mohab"}
    ...
    def get_refrences(self):
        ...
        ref_folder_path = r'C:\PyCharm codes for hanona\Third Biomedical Year, Second Term\Computer Vision\Task 5 CV\Trial 4\ref2'
